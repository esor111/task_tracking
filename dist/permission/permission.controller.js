...
let PermissionController = exports.PermissionController = class PermissionController {
    ...
    async addpermissiontoRole(addpermission, roleid) {
...
__decorate([
    (0, swagger_1.ApiQuery)({
        name: 'ids',
        type: create_business_dto_1.addpermissionToRoleDto,
        explode: false,
        isArray: true,
    }),
    (0, common_1.Post)('rolepermission/:roleId'),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Query)('roleId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_business_dto_1.addpermissionToRoleDto, Number]),
    __metadata("design:returntype", Promise)
], PermissionController.prototype, "addpermissiontoRole", null);
__decorate([
    (0, common_1.Get)(':id'),
